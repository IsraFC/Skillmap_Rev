        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Father_LastName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Mother_LastName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceFeedbacks", x => new { x.ID_Resource, x.ID_User });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Resource_Type = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceTypes", x => x.Id_Resource_Type);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_Teacher = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subjects", x => x.ID_Subject);
                    table.ForeignKey(
                        name: "FK_Subjects_AspNetUsers_ID_Teacher",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectResources", x => new { x.ID_Subject, x.ID_Resource });
                    table.ForeignKey(
                        name: "FK_SubjectResources_ResourcesItems_ID_Resource",
                        column: x => x.ID_Resource,
                        principalTable: "ResourcesItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectResources_Subjects_ID_Subject",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectResources_ID_Resource",
